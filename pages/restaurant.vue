    ...
    <nav class="sticky top-0 z-50 bg-red-600 dark:bg-red-900 shadow-lg">
      <div class="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-6">
          <a href="#home" class="text-white hover:text-red-200 font-medium transition-colors duration-300" :class="{ 'border-b-2 border-white pb-1': activeSection === 'home' }">Home</a>
          <a href="#menu" class="text-white hover:text-red-200 font-medium transition-colors duration-300" :class="{ 'border-b-2 border-white pb-1': activeSection === 'menu' }">Menu</a>
          <a href="#gallery" class="text-white hover:text-red-200 font-medium transition-colors duration-300" :class="{ 'border-b-2 border-white pb-1': activeSection === 'gallery' }">Gallery</a>
          <a href="#services" class="text-white hover:text-red-200 font-medium transition-colors duration-300" :class="{ 'border-b-2 border-white pb-1': activeSection === 'services' }">Services</a>
          <a href="#about" class="text-white hover:text-red-200 font-medium transition-colors duration-300" :class="{ 'border-b-2 border-white pb-1': activeSection === 'about' }">About</a>
          <a href="#contact" class="text-white hover:text-red-200 font-medium transition-colors duration-300" :class="{ 'border-b-2 border-white pb-1': activeSection === 'contact' }">Contact</a>
